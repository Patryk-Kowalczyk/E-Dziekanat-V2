...
class PartialGradeService
{
    ...
    public function getAllStudentPartialGrades(): JsonResponse
    {
        try {
            ...
            return Response::build($studentSubjectsWithPartialGrades, 200,__('msg/success.list'));
        } catch (\Exception $e) {
            Log::error("There was problem with PartialGradeService.getAllStudentPartialGrades(): ", ['error' => $e]);
    ...
    public function getPartialGradesForEducatorPanel(): JsonResponse
    {
        try {
            ...
            return Response::build($educatorSubjectsWithPartialGradesTransformResponse, 200,__('msg/success.list'));
        } catch (\Exception $e) {
            Log::error("There was problem with PartialGradeService.getPartialGradesForEducatorPanel(): ", ['error' => $e]);
            return Response::build([], 500, __('msg/error.list'));
        }
    }
    ...
    public function storePartialGrades($data): JsonResponse
    {
        try {
            ...
            Log::error("There was problem with PartialGradeService.storePartialGrades(): ", ['error' => $e]);
