...
const Form = ({ element, infoGroup, infoForm, s_id }) => {
  ...
  return (
    <>
      <div
        key={element.unique_number}
        className="nameLastName"
      ...
      {isOpenForm && (
        <div className="marksForm">
          <form>
            ...
            {isVisible === false ? (
              <div className="divPlus" onClick={() => setIsVisible(!isVisible)}>
                +
              </div>
            ) : (
              <div className="divPlus" onClick={() => setIsVisible(!isVisible)}>
            ...
            <button onClick={handleOnClick} className="buttonForm">
              Zatwierdź
            </button>
          </form>
        </div>
